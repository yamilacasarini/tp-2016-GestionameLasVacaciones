...
RETURN (SELECT funcionalidad.id, funcionalidad.descripcion
 ...
 CREATE PROCEDURE GESTIONAME_LAS_VACACIONES.elRolNoExiste(@nombreRol VARCHAR(30))
 AS
BEGIN
IF NOT EXISTS (SELECT * FROM GESTIONAME_LAS_VACACIONES.Roles WHERE descripcion = @nombreRol)
BEGIN
