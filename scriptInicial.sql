...
INSERT INTO GESTIONAME_LAS_VACACIONES.Modificaciones (idPaciente,idPlan)
SELECT cast((dni*100) as nvarchar(13)),idPlan  from #PacienteTemporal group by dni ,idPlan
